// auth.js - Flujo de Autenticación, Perfiles, Traducción, Interfaz Responsive y Reproductor
...
function conectarMenuDrawer() {
  ...
  drawerLinks.forEach((link) => {
    link.onclick = (e) => {
      ...
      if (key === 'catalogHome' || key === 'home' || texto.includes('inicio')) {
        entrarPlataforma({ isKids: currentPerfilKids, filtroTipo: 'todos' });
      ...
      } else if (key === 'catalogKids' || key === 'kids' || texto.includes('niño') || texto.includes('kids')) {
