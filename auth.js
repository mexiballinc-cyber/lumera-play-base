  ...
  let html = `
    <div style="padding: 20px 10px; text-align: center; max-width: 800px; margin: 10px auto;">
      ...
      <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 25px; position: relative;">
        ...
        <button id="btnEditarPerfilesMode" title="${t.editProfiles}" style="position: absolute; right: 10px; background: transparent; border: 1px solid #d4af37; color: #d4af37; border-radius: 50%; width: 38px; height: 38px; cursor: pointer; display: flex; align-items: center; justify-content: center;">
...
// CONECTAR Y CERRAR EL DRAWER SIEMPRE
